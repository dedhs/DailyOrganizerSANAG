...
$testVariable = "Hurra wir leben noch!";
...
$html1 = "
<style>
div { text-align: justify; color: blue; }
</style>
<h2>Joanne Smith 2002-2007</h2>
<div>This is the normal text in the div: $testVariable Nulla felis erat, imperdiet eu, ullamcorper non, 
nonummy quis, elit. Suspendisse potenti. Ut a eros orci. Morbi feugiat pulvinar dolor. Cras odio. Donec mattis, nisi id 
euismod auctor, neque metus pellentesque,  /> nulla. Integer sit amet odio sit amet 
lectus luctus euismod. Donec et nulla. Sed quis orci. </div>
";

$html2 = '
<style>
div { text-align: justify; color: red;}
</style>
